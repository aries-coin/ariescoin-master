...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 10)
  {
    ...
    else if(pindexBest->nHeight+1 >= 11 && pindexBest->nHeight+1 <= 900000000)
  {
    nSubsidy = 0 * COIN;
  }
...
// ariescoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ariescoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "AriesCoin";
        CTransaction txNew;
        txNew.nTime = 1498203760;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa3c10970f486080807c06cf95d137a156b61d6d9bf87d002595295a9c4f80f3e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0x3d, 0xa4, 0xf2 };
